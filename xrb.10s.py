...
def flow():
    if result_cmc[0]['percent_change_1h'] > '0':
        print (' %.8f ($%.2f) | image= color=#000000'% (float(result_kucoin['data']['lastDealPrice']), float(result_cmc[0]['price_usd'])) )
    else:
        print (' %.8f ($%.2f) | image= color=#000000'% (float(result_kucoin['data']['lastDealPrice']), float(result_cmc[0]['price_usd'])) )
